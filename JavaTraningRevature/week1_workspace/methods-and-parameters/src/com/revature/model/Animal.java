...
public class Animal {
	...
	// Method overloading: If you have 2 or more methods with the same name defined in the same class,
	//but with different numbers of parameters / type of parameter.
