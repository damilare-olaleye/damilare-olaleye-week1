...
public class Application {
	/*
	 * Introduction to Java and Java naming conventions
	 */
	...
	// Classes: class names should be nouns with the first letter of each word capitalized. (ex. public class SodaCan)
	// Methods: Verbs, mixed case with the first letter lowercase, and every subsequent word's first letter capitalized (ex. public static void makeAlotOfNoise() {})
